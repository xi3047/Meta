...
public class L498_DiagonalTraverse {
    /**
     * Use a goingUp flag to denote its direction,
     * corner case: if we are at top right corner or bottom left corner
     * we have to check right boundary  and bottom boundary first
