...
public class L1762_BuildingsWithAnOceanView {
    /**
     * From left to right
     * Using stack to remove previous buildings that are blocked by current one
     */
    ...
    /**
     * From right to left, keep a highest building
     * if cur is highest, add to result, update highest
     *
     */
