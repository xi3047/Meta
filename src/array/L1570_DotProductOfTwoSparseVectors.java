...
public class L1570_DotProductOfTwoSparseVectors {
    /**
     * index to value map
     * only store nonzero values to save space
     * check if other map has number on same index,
     * if has, compute and add to result
     */
    class SparseVector {
     ...
     * when given a range of compressed values
     * we can segment the vector and find overlaps
     * with two pointers, check
     *  0  1  2  3  4  5  6  7  8
     * [1, 1, 1, 3, 3, 3, 3, 6, 6]
